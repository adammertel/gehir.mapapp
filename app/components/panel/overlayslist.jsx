  ...
  render() {
    return (
      <div style={Styles['PANEL_LIST']()}>
        <div
          style={Styles['PANEL_HEADER_ROW']()}
          onClick={this._handleExpand.bind(this)}
        >
          <h4 style={Styles['PANEL_HEADER_TITLE']()}>Auxiliary Layers:</h4>
          <FontIcon
              ...
              return (
                <div key={mapOverlayKey} style={Styles['PANEL_BUTTON_ROW']()}>
                  <Checkbox
                    ...
                    onClick={this.props.handleChangeOverlays.bind(
                      this,
                      mapOverlay.id
                    )}
                    checked={
                      appState.activeOverlays.indexOf(mapOverlay.id) != -1
                    }
                    style={Styles['PANEL_BUTTON_CELL']()}
                    labelStyle={Styles['PANEL_BUTTON_CELL_LABEL']()}
                    iconStyle={Styles['PANEL_BUTTON_CELL_ICON']()}
                  />
                </div>
              );
            })}
