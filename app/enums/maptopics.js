...
var MapTopics = {
  'CHRISTROME': {
    ...
    bibliography: ['Van Dam, Raymond, and Ramsay MacMullen. "The Second Church: Popular Christianity AD 200–400. Writings from the Greco-Roman World Supplement Series, vol. 1." (2009): 690-692.'],
  ...
  'ISIS': {
    ...
    bibliography: ['Bricault, L. (2005). Recueil des inscriptions concernant les cultes isiaques: RICIS. Paris: Académie des inscriptions et belles-lettres.'],
  ...
  'MARLUC': {
    ...
    bibliography: ['Van der Meer, Frederik, and Christine Mohrmann. Atlas of the Early Christian World. Nelson, 1958.', 'Runesson, Anders, Donald D. Binder, and Birger Olsson, eds. The ancient synagogue from its origins to 200 CE: a source book. Vol. 72. Brill, 2008.'],
